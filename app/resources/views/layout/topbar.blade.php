                 ...
                 {                    
                    //  $('#productosModal').modal('show');
                     ...
                     $.each(data , function(index, val) { 
                        ...
                        document.getElementById("demo").innerHTML = "<div class='col-lg-3 col-md-6 col-sm-12 pb-1'><div class='card product-item border-0 mb-4'> <img class='img-fluid w-100' src='' alt=''></div><div class='card-body border-left border-right text-center p-0 pt-4 pb-3'><h6 class='text-truncate mb-3'>nombre</h6><div class='d-flex justify-content-center'><h6>4500Gs</h6><h6 class='text-muted ml-2'></h6></div></div><div class='card-footer d-flex justify-content-between bg-light border'><a href='' class='btn btn-sm text-dark p-0'></div></div></div>"
